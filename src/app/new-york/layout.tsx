...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New York Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/new-york", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "New York Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/new-york" },
};
