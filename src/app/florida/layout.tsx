...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Florida Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/florida", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/florida" },
};
