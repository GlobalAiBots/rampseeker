...
export const metadata: Metadata = {
  ...
  openGraph: { title: "North Dakota Boat Ramps — RampSeeker", url: "https://rampseeker.com/north-dakota", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "North Dakota Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://rampseeker.com/north-dakota" },
};
