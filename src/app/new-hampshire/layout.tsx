...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Hampshire Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/new-hampshire", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "New Hampshire Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/new-hampshire" },
};
