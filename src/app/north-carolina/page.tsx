...
export default function NorthCarolinaPage() {
  ...
  const cityMap = useMemo(() => {
    ...
    for (const r of ncRamps) { const c = r.city?.trim(); if (c && c.length > 1) m[c] = (m[c] || 0) + 1; }
