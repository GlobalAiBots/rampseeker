...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Massachusetts Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/massachusetts", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Massachusetts Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/massachusetts" },
};
