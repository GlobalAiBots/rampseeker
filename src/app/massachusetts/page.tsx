    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 pt-10 pb-2">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-6">
          <h2 className="font-[Cabin] text-xl font-bold text-charcoal mb-3">Boating in Massachusetts</h2>
          <p className="text-gray-600 leading-relaxed text-sm">Massachusetts offers {stRamps.length.toLocaleString()}+ public boat ramps across its waterways. From Quabbin Reservoir, Cape Cod, and the Connecticut River, the state provides excellent access for boaters, anglers, and kayakers. Popular catches include bass, trout, and striped bass. <Link href="/blog/how-to-launch-a-boat-safely" className="text-water hover:underline">Learn how to launch safely</Link>.</p>
        </div>
