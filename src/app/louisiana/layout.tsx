...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Louisiana Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/louisiana", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Louisiana Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/louisiana" },
};
