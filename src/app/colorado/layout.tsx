...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Colorado Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/colorado", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Colorado Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/colorado" },
};
