...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Georgia Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/georgia", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Georgia Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/georgia" },
};
