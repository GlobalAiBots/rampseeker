    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong className="text-charcoal">Insert the drain plug.</strong> This sounds obvious, but every ramp regular has watched a boat fill with water because someone forgot the plug. Check it twice. Make it part of your muscle memory.</li>
          <li><strong className="text-charcoal">Load your gear.</strong> Coolers, tackle boxes, rods, life jackets &mdash; load everything while you&apos;re in the parking lot. Don&apos;t do it on the ramp while others are waiting.</li>
          ...
          <li><strong className="text-charcoal">Attach your bow and stern lines.</strong> Have dock lines ready to tie off at the courtesy dock as soon as the boat is in the water.</li>
        </ul>
