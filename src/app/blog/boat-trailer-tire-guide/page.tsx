    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Boat Trailer Tire Guide", "item": `https://www.rampseeker.com/blog/boat-trailer-tire-guide` },
        ],
      }) }} />
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>To slow UV damage, use <a href="https://www.amazon.com/s?k=trailer+tire+covers+set+of+4&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">tire covers (Our Pick on Amazon)</a> when the trailer is stored. If you don&apos;t have covers, park the trailer in shade or at least move it periodically so the same tire sections aren&apos;t facing the sun for months. A UV protectant spray can help, but it&apos;s no substitute for covers on long-term storage.</p>
        ...
        <p>This sounds obvious, but a surprising number of boat trailers don&apos;t have a spare tire. And of those that do, many have a spare that&apos;s flat, dry-rotted, or the wrong size. <strong className="text-charcoal">Your spare tire needs the same maintenance as your road tires.</strong> Check its pressure before every trip. Inspect it for cracks &mdash; a <a href="https://www.amazon.com/s?k=spare+tire+cover+trailer&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">spare tire cover (Our Pick on Amazon)</a> protects it from UV damage during storage. Make sure you have a lug wrench that fits your trailer lug nuts (they&apos;re often a different size than your truck&apos;s).</p>
        ...
        <p>Load Range C tires (1,820 lbs each at 50 PSI) are common on lighter trailers. Heavier boats need Load Range D (2,540 lbs each at 65 PSI) or E tires. Never downgrade from the tire size and load rating that came on your trailer. If you&apos;re upgrading to a heavier boat, you may need to upgrade to heavier-duty <a href="https://www.amazon.com/s?k=radial+trailer+tires+ST+load+range+D&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">radial trailer tires (Our Pick on Amazon)</a> too.</p>
