  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p><strong className="text-charcoal">What to do:</strong> If bearings have more than 20-30 launches on them, repack with <a href="https://www.amazon.com/s?k=marine+grease+waterproof+trailer+bearings&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">marine-grade grease (Our Pick on Amazon)</a>. If they show any roughness, replace them — a <a href="https://www.amazon.com/s?k=boat+trailer+bearing+kit&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">bearing kit (Our Pick on Amazon)</a> costs $15-30 and takes 30 minutes per wheel. If you have Bearing Buddy caps, pump fresh grease through them before the season.</p>
        ...
        <p><strong className="text-charcoal">What to do:</strong> Replace any tire older than 5 years, regardless of tread. Replace tires with visible sidewall cracking. Always carry a properly inflated spare. Consider upgrading to <a href="https://www.amazon.com/s?k=radial+trailer+tires+ST+boat&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">radial trailer tires (Our Pick on Amazon)</a> — they run cooler and last longer than bias-ply.</p>
        ...
        <p><strong className="text-charcoal">What to do:</strong> Clean corroded connections with electrical contact cleaner and apply dielectric grease. If bulbs keep burning out from water exposure, upgrade to sealed <a href="https://www.amazon.com/s?k=submersible+LED+trailer+light+kit&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">LED trailer lights (Our Pick on Amazon)</a> — they&apos;re waterproof, brighter, last longer, and draw less power. A full LED conversion kit costs $30-60 and takes an hour to install.</p>
        ...
        <p><strong className="text-charcoal">What to check:</strong> Inspect the entire length of the <a href="https://www.amazon.com/s?k=boat+trailer+winch+strap+replacement&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">winch strap (Our Pick on Amazon)</a> for fraying, cuts, or UV damage. Check the hook and ratchet mechanism. Check the bow safety chain — it should be your backup if the strap fails. Test the winch — it should ratchet smoothly and hold under load.</p>
        ...
        <p><strong className="text-charcoal">What to do:</strong> Replace <a href="https://www.amazon.com/s?k=boat+trailer+bunk+carpet+kit&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">bunk carpet (Our Pick on Amazon)</a> that&apos;s worn through — bare wood scratches gel coat. Replace cracked or flat-spotted rollers. Grease roller axles. Tighten guide post bolts.</p>
