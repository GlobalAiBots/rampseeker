    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Spring Boat Prep", "item": `https://www.rampseeker.com/blog/spring-boat-prep` },
        ],
      }) }} />
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>With the boat on the trailer, walk around and inspect the hull from bow to stern. Look for cracks, blisters, gel coat chips, and any signs of impact damage. Check the drain plug and make sure the O-ring is in good shape &mdash; a leaking drain plug can sink a boat at the ramp faster than you&apos;d think. Inspect through-hull fittings, the transducer, and the trim tabs for damage or corrosion. If your boat has bottom paint, assess whether it needs a fresh coat. Open all hatches and compartments and inspect for mold, mildew, rodent damage, and standing water. A thorough visual inspection now catches small problems before they become big ones on the water. Once you&apos;ve made your repairs, a coat of <a href="https://www.amazon.com/s?k=marine+polish+wax+gel+coat&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">marine polish (Our Pick on Amazon)</a> restores the gel coat&apos;s shine and adds a UV barrier, while a dedicated <a href="https://www.amazon.com/s?k=boat+hull+cleaner+waterline+stain&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">hull cleaner (Our Pick on Amazon)</a> removes the waterline stains and scum line that built up last season.</p>
