    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Must-Have Boat Trip Items", "item": `https://www.rampseeker.com/blog/must-have-boat-trip-items` },
        ],
      }) }} />
