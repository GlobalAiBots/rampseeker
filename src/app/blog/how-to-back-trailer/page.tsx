  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>The absolute best thing you can do is practice in an empty parking lot. Set up two traffic cones (or water bottles, or anything visible) to simulate a ramp lane. Practice backing between them from different angles. Do this for an hour and you&apos;ll show up at the ramp with real confidence. <strong className="text-charcoal">Practice on a weekday afternoon, not on a holiday weekend with 15 boats waiting behind you.</strong></p>
