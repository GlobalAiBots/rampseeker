...
export default function Post() {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Article", headline: post.title, datePublished: "2026-03-12", author: { "@type": "Organization", name: "RampSeeker Team" }, publisher: { "@type": "Organization", name: "RampSeeker", url: "https://rampseeker.com" } }) }} />
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong className="text-charcoal">Oklahoma:</strong> Major ramps on <Link href="/oklahoma/lakes/grand-lake" className="text-water hover:underline">Grand Lake</Link>, <Link href="/oklahoma/lakes/tenkiller-ferry-lake" className="text-water hover:underline">Tenkiller</Link>, and Lake Texoma have lighting. Wolf Creek Park and Honey Creek are well-lit on Grand Lake. Many GRDA ramps also have pole lights.</li>
        ...
        <p><strong className="text-charcoal">Headlamp with red light mode.</strong> This is the single most important piece of night-launching gear. A good headlamp frees both hands for handling ropes, straps, and dock cleats. The red light mode preserves your night vision — white light blinds you for several minutes, making it harder to see the ramp, the water, and your surroundings. A quality headlamp costs $20-30 and lasts for years.</p>
        <p><strong className="text-charcoal">Working trailer lights.</strong> Your trailer lights serve double duty at night: they&apos;re legally required for road travel, and they illuminate the ramp behind you while backing. Check every bulb before you leave — a burned-out brake light that you&apos;d ignore during the day is a real problem at 4:00 AM when it&apos;s your only source of ramp illumination. LED trailer lights are brighter and more reliable than incandescent.</p>
        <p><strong className="text-charcoal">Reflective tape.</strong> Put reflective tape on your trailer fenders, guide posts, and the back of the boat. When your headlamp or truck headlights hit the tape, the whole trailer lights up. This helps you see alignment while backing and helps other boaters see your trailer in the water. A $5 roll of reflective tape from the hardware store is one of the best investments you&apos;ll make.</p>
        <p><strong className="text-charcoal">Waterproof flashlight or lantern.</strong> Keep a dedicated waterproof flashlight in the boat for tying off at the dock, checking the drain plug, and inspecting the ramp surface. A small LED lantern hung from the boat&apos;s T-top or console provides ambient light while you prep gear on the water.</p>
