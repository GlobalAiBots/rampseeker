    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Kayak Launch Sites", "item": `https://www.rampseeker.com/blog/kayak-launch-sites` },
        ],
      }) }} />
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>Beyond your kayak, paddle, and PFD, a few items make launching easier. A <a href="https://www.amazon.com/s?k=kayak+cart+wheels+transport&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">kayak cart (Our Pick on Amazon)</a> makes the carry from parking lot to water manageable, especially for heavier fishing kayaks. <a href="https://www.amazon.com/s?k=waterproof+dry+bag+kayak&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">Dry bags (Our Pick on Amazon)</a> protect your phone, keys, and wallet. A <a href="https://www.amazon.com/s?k=kayak+paddle+leash&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-water hover:underline font-semibold">paddle leash (Our Pick on Amazon)</a> prevents losing your paddle if you capsize. And a <strong className="text-charcoal">bilge pump or sponge</strong> keeps water out of your cockpit. Check out our <Link href="/checklist" className="text-water hover:underline">complete boating checklist</Link> for more gear recommendations.</p>
