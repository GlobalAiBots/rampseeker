  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>Grand Lake has dozens of ramps, but kayakers should head to the smaller, less-trafficked launches. The coves on the east side of the lake near <Link href="/oklahoma/lakes/grand-lake" className="text-water hover:underline">Grand Lake&apos;s ramp list</Link> offer sheltered water and gradual shorelines. Wolf Creek Park on the north end has a gentle slope with a courtesy dock — one of the best kayak put-ins on the lake. Avoid the main marina ramps on summer weekends unless you enjoy dodging wake boats.</p>

        <h3 className="font-[Cabin] text-xl font-bold text-charcoal mt-8">Lake Tenkiller, Oklahoma</h3>
        <p>Tenkiller&apos;s clear water and sheltered coves make it a paddler&apos;s paradise. Several USACE ramps on <Link href="/oklahoma/lakes/tenkiller-ferry-lake" className="text-water hover:underline">Tenkiller</Link> have sandy beaches adjacent to the concrete that work perfectly for kayak launches. The ramps on the upper end of the lake tend to be quieter and have gentler approaches than the busy spots near the dam.</p>
