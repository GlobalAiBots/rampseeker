...
export default function Post() {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Article", headline: post.title, datePublished: "2026-03-15", author: { "@type": "Organization", name: "RampSeeker Team" }, publisher: { "@type": "Organization", name: "RampSeeker", url: "https://www.rampseeker.com" } }) }} />
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>Drought years hit particularly hard. In 2022 and 2023, multiple ramps on Texas lakes were completely high and dry for months. Oklahoma lakes like <Link href="/grand-lake" className="text-water hover:underline">Grand Lake</Link> and <Link href="/lakes/tenkiller-ferry-lake" className="text-water hover:underline">Tenkiller</Link> can also be affected when the Corps draws down water levels for flood control or power generation.</p>
