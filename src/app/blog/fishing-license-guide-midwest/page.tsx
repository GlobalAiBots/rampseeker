  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <p>Oklahoma also requires a free &quot;Paddlefish Permit&quot; if you plan to snag paddlefish on <Link href="/oklahoma/lakes/grand-lake" className="text-water hover:underline">Grand Lake</Link> or the Neosho River. A separate trout stamp is not required — trout fishing is included with the standard fishing license.</p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong className="text-charcoal">Grand Lake / Neosho River (Oklahoma/Kansas):</strong> The upper end of <Link href="/oklahoma/lakes/grand-lake" className="text-water hover:underline">Grand Lake</Link> extends into Kansas. An Oklahoma license covers you on the entire lake, including the Kansas portion. However, if you fish the Neosho River above the lake in Kansas, you need a Kansas license.</li>
