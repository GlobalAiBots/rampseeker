...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Illinois Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/illinois", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Illinois Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/illinois" },
};
