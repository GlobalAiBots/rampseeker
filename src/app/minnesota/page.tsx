...
export default function MinnesotaPage() {
  ...
  const cityMap = ((precomputedCities as unknown) as Record<string, [string, number][]>)["minnesota"] || [];
