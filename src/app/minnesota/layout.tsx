...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Minnesota Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/minnesota", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Minnesota Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/minnesota" },
};
