...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Mexico Boat Ramps — RampSeeker", url: "https://rampseeker.com/new-mexico", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "New Mexico Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://rampseeker.com/new-mexico" },
};
