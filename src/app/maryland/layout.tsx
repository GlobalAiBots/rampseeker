...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Maryland Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/maryland", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Maryland Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/maryland" },
};
