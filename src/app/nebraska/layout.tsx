...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Nebraska Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/nebraska", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Nebraska Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/nebraska" },
};
