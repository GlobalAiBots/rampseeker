...
export const metadata: Metadata = {
  ...
  openGraph: { title: "New Jersey Boat Ramps — RampSeeker", url: "https://rampseeker.com/new-jersey", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "New Jersey Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://rampseeker.com/new-jersey" },
};
