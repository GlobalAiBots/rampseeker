...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Connecticut Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/connecticut", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Connecticut Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/connecticut" },
};
