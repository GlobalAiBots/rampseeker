      ...
      <div className="space-y-6 text-gray-600 leading-relaxed">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 my-8">
          ...
          <p className="text-gray-600">
            We now cover 15 states — Oklahoma, Texas, Missouri, Arkansas, Kansas, Florida, Michigan, Minnesota, North Carolina, New York, Illinois, Ohio, Washington, Alabama, and Georgia — with thousands of boat ramps. We&apos;re adding detailed guides with local tips for every major lake, and expanding to all 50 states.
          </p>
        </div>
