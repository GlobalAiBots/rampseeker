...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Washington Boat Ramps — RampSeeker", url: "https://rampseeker.com/washington", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Washington Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://rampseeker.com/washington" },
};
