...
export default function WashingtonPage() {
  ...
  const cityMap = useMemo(() => {
    ...
    for (const r of waRamps) { const c = r.city?.trim(); if (c && c.length > 1) m[c] = (m[c] || 0) + 1; }
  ...
  return (
    <div>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          { "@type": "Question", name: "How many boat ramps are in Washington?", acceptedAnswer: { "@type": "Answer", text: `There are ${waRamps.length} boat ramps in Washington. RampSeeker has mapped every public boat launch across the state.` } },
          { "@type": "Question", name: "Are boat ramps in Washington free?", acceptedAnswer: { "@type": "Answer", text: "Many boat ramps in Washington are free, especially those managed by state parks or the Army Corps of Engineers. Some may charge a launch fee." } },
          { "@type": "Question", name: "How do I find boat ramps near me in Washington?", acceptedAnswer: { "@type": "Answer", text: `Use RampSeeker to browse all ${waRamps.length} boat ramps in Washington by city. Each listing includes a map and directions.` } },
        ],
      }) }} />
      ...
      <section className="max-w-4xl mx-auto px-4 pt-10 pb-2">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-6">
          <h2 className="font-[Cabin] text-xl font-bold text-charcoal mb-3">Boating in Washington</h2>
          <p className="text-gray-600 leading-relaxed text-sm">Washington offers {waRamps.length.toLocaleString()}+ public boat ramps across its waterways. From Puget Sound, Lake Chelan, and the Columbia River, the state provides excellent access for boaters, anglers, and kayakers. Popular catches include salmon, steelhead, and walleye. <Link href="/blog/how-to-launch-a-boat-safely" className="text-water hover:underline">Learn how to launch safely</Link>.</p>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mb-6">
          <h3 className="font-[Cabin] font-bold text-water mb-3">Tips for Boating in Washington</h3>
          <ul className="space-y-2 text-sm text-gray-700">
            <li className="flex items-start gap-2"><span className="text-water mt-0.5">&#10003;</span> Washington requires all motorized boats to be registered before launching at any public ramp.</li>
            <li className="flex items-start gap-2"><span className="text-water mt-0.5">&#10003;</span> A fishing license is required for anyone 16+ fishing from a boat in Washington.</li>
            <li className="flex items-start gap-2"><span className="text-water mt-0.5">&#10003;</span> Life jackets are required for all children under 13 on any watercraft in Washington.</li>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="space-y-2">
          {[
            { q: "How many boat ramps are in Washington?", a: `RampSeeker lists ${waRamps.length}+ boat ramps across Washington, from Puget Sound to the Columbia River basin.` },
            { q: "What are the best fishing spots in Washington?", a: "Puget Sound offers world-class salmon, halibut, and lingcod. The Columbia River is legendary for salmon and sturgeon. Lake Chelan, Banks Lake, and Lake Roosevelt provide excellent freshwater fishing for walleye, bass, and trout." },
            { q: "Do I need a boating license in Washington?", a: "Washington requires a Boater Education Card for anyone operating a motorized vessel who was born after January 1, 1955. All motorized boats must be registered with the WA Department of Licensing." },
          
            { q: "Do I need a boating license in Washington?", a: "Washington requires a boating safety education certificate for boat operators. Check with the state's wildlife agency for specific age and horsepower requirements." },
            { q: "When is the best time to boat in Washington?", a: "Peak boating season in Washington runs from May through October, but many waterways are accessible year-round. Spring and fall offer less crowded conditions and excellent fishing." },
          ].map((f, i) => (
