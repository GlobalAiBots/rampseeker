...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Grand Lake Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/grand-lake", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Grand Lake Boat Ramps — RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/grand-lake" },
};
