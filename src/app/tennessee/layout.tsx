...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Tennessee Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/tennessee", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "Tennessee Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/tennessee" },
};
