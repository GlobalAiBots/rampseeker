...
export const metadata: Metadata = {
  ...
  openGraph: { title: "California Boat Ramps — RampSeeker", url: "https://www.rampseeker.com/california", siteName: "RampSeeker" },
  twitter: { card: "summary", title: "California Boat Ramps | RampSeeker" },
  alternates: { canonical: "https://www.rampseeker.com/california" },
};
