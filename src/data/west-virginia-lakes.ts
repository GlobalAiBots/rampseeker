...
import data from "./west-virginia-lakes.json";

export const westVirginiaLakes: Lake[] = data.map((l) => ({
...
export function getWestVirginiaLakeById(id: string): Lake | undefined {
  return westVirginiaLakes.find((l) => l.id === id);
}

export function getWestVirginiaLakeForRamp(lat: number, lng: number): Lake | undefined {
