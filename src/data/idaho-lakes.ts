...
import data from "./idaho-lakes.json";

export const idahoLakes: Lake[] = data.map((l) => ({
...
export function getIdahoLakeById(id: string): Lake | undefined {
  return idahoLakes.find((l) => l.id === id);
}

export function getIdahoLakeForRamp(lat: number, lng: number): Lake | undefined {
