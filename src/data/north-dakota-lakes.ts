...
import data from "./north-dakota-lakes.json";

export const northDakotaLakes: Lake[] = data.map((l) => ({
...
export function getNorthDakotaLakeById(id: string): Lake | undefined {
  return northDakotaLakes.find((l) => l.id === id);
}

export function getNorthDakotaLakeForRamp(lat: number, lng: number): Lake | undefined {
