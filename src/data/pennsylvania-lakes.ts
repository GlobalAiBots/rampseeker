...
import data from "./pennsylvania-lakes.json";

export const pennsylvaniaLakes: Lake[] = data.map((l) => ({
...
export function getPennsylvaniaLakeById(id: string): Lake | undefined {
  return pennsylvaniaLakes.find((l) => l.id === id);
}

export function getPennsylvaniaLakeForRamp(lat: number, lng: number): Lake | undefined {
