...
import data from "./virginia-lakes.json";

export const virginiaLakes: Lake[] = data.map((l) => ({
...
export function getVirginiaLakeById(id: string): Lake | undefined {
  return virginiaLakes.find((l) => l.id === id);
}

export function getVirginiaLakeForRamp(lat: number, lng: number): Lake | undefined {
