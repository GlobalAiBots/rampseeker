...
import data from "./alaska-lakes.json";

export const alaskaLakes: Lake[] = data.map((l) => ({
...
export function getAlaskaLakeById(id: string): Lake | undefined {
  return alaskaLakes.find((l) => l.id === id);
}

export function getAlaskaLakeForRamp(lat: number, lng: number): Lake | undefined {
