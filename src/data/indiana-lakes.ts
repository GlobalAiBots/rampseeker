...
import data from "./indiana-lakes.json";

export const indianaLakes: Lake[] = data.map((l) => ({
...
export function getIndianaLakeById(id: string): Lake | undefined {
  return indianaLakes.find((l) => l.id === id);
}

export function getIndianaLakeForRamp(lat: number, lng: number): Lake | undefined {
